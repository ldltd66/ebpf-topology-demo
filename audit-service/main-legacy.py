"""
audit-service  (legacy – Python 3.8 compatible)
Receives audit events from trade-service and forwards them to archive-service
with exponential backoff retry logic.

Changes from main.py for Python 3.8 compatibility:
  • set[str]          → Set[str]          (typing)
  • list[str]         → List[str]         (typing)
  • dict[str, str]    → Dict[str, str]    (typing)
  • tuple[..., ...]   → Tuple[..., ...]   (typing)
"""
