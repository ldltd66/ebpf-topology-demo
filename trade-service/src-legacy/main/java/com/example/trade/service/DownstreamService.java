...
public class DownstreamService {
    ...
    // JDK 8 compatible: replaced Set.of() with Collections.unmodifiableSet(new HashSet<>(Arrays.asList(...)))
    private static final Set<String> FORWARDED_HEADERS = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
    ...
    public String resolveRequestId(HttpHeaders incomingHeaders, String fallbackId) {
        ...
        // JDK 8 compatible: replaced .isBlank() with .trim().isEmpty()
