...
public class TradeController {
    ...
    // JDK 8 compatible: extracted List.of() to a static constant using Arrays.asList()
    private static final List<String> TRACKED_HEADERS = Arrays.asList(
    ...
    public ResponseEntity<Map<String, String>> health() {
        ...
        resp.put("status", "ok");
        resp.put("service", "trade-service");
    ...
    private Map<String, String> buildHeaderMap(HttpHeaders headers) {
        ...
        // JDK 8 compatible: replaced List.of() with TRACKED_HEADERS constant (Arrays.asList)
        for (String name : TRACKED_HEADERS) {
